...
public class BoardController {
	...
	public String listByUserId(@PathVariable(value = "userName") String userName, Pageable pageable, Model model) {
		log.info("KANG-20200803 >>>>> {} {}", CurrentInfo.get());
		model.addAttribute("boardList", this.boardService.findBoardListByUserName(pageable, userName));
		return "board/list";
	}
}
